export const constants = {
    ...
    DISCORD_OAUTH_URL: 'https://discord.com/oauth2/authorize?client_id=1006520438865801296&permissions=269872255&response_type=code&redirect_uri=https%3A%2F%2Ffoxybot.win%2Flogin%2Fcallback&integration_type=0&scope=guilds+bot+applications.commands+email+identify',
    GITHUB_URL: 'https://github.com/FoxyTheBot/Foxy',
    DISCORD_SERVER_URL: 'https://discord.gg/6mG2xDtuZD',
    PRIVACY_POLICY_URL: 'https://foxybot.win/br/support/terms',
